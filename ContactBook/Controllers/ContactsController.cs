        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,Address1,Address2,City,State,ZipCode,Email,PhoneNumber,ImageFile")] Contact contact)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (contact.ImageFile != null)
                {
                    ...
                    contact.ImageType = contact.ImageFile.ContentType; //file uploading based on the header (safer)
                }
            ...
            return RedirectToAction(nameof(Index)); //saving and redirecting to list of items
        }
